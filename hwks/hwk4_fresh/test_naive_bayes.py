...
class test_NaiveBayes(unittest.TestCase):
    ...
    def test_liked_prob(self):
        ...
        self.assertAlmostEqual(0.334437086, nb_table.user_prob(3, liked=True), 5,
        ...
        # TODO: HOMEWORK 4. Put correct calculated value here
        self.assertAlmostEqual(0.003311258, nb_table.user_prob(5, liked=False), 5,
    ...
    def test_cond_prob(self):
        nb_table = self._algo._nb_table
        # TODO: HOMEWORK 4. Put correct calculated value here
        self.assertAlmostEqual(0.99019607843, nb_table.user_feature_prob(1, 'D', liked=True), 5,
    ...
    def test_pred2(self):
        ...
        # TODO: HOMEWORK 4. Put correct calculated value here
        self.assertAlmostEqual(3.931825633, score, 5,
    ...
    def test_pred3(self):
        ...
        # TODO: HOMEWORK 4. Put correct calculated value here
        self.assertAlmostEqual(6.161364087, score, 5,
