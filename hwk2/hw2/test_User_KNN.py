...
class test_User_KNN(unittest.TestCase):
    ...
    def test_similarities_hwk2(self):
        ...
        self.assertAlmostEqual(sim2[1], 0.83333333, 5, "Error in similarity computation FIX FOR HOMEWORK 2")
    ...
    def test_predict_hwk2(self):
        ...
        self.assertAlmostEqual(pred, 1.94132358, 4, 'Prediction incorrect. FIX FOR HOMEWORK 2')
        ### INSERT CORRECT VALUE HERE^
